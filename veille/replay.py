...
def main() -> int:
    ...
    parser.add_argument("--max-per-account", type=int, default=8, help="Quota de tweets par compte et par jour.")
    parser.add_argument("--max-per-day", type=int, default=250, help="Garde-fou global strict par jour (budget).")
    parser.add_argument("--max-pages", type=int, default=3, help="Pages advanced_search max par compte et par jour.")
